...
<?php require("side menu.php") ?>
    ...
    <center>
        ...
        <form action="../php/experience script.php" method="POST" >
            ...
            <img src="../icon packs/149086-essential-set/png/clock.png" width="250" height="250">
                ...
                <input name="input1a" id="input1a" type="text" placeholder="company name" />
                <input name="input1b" id="input1b" type="text"  placeholder="role" style="margin-bottom: 10;" />
                </br>
                <div class="desktop">
                ...
                <button id="add1" type="button" class="gen" >
                    <p class="gen-black">add experience</p>
                </button>
                ...
                <div id="content1" style="display:none">
                    ...
                    <input name="input2a" id="input2a" type="text" placeholder="company name" />
                <input name="input2b" id="input2b" type="text"  placeholder="role" style="margin-bottom: 10;" />
                </br>
                <div class="desktop">
                <p class="gen-black" style="display:inline-block;float:left;margin-left:300;">start date</p>
                <p class="gen-black"style="display:inline-block;margin-bottom:20;"></p>
                ...
                <div id="content2" style="display:none">
                    ...
                    <input name="input3a" id="input3a" type="text" placeholder="company name" />
                <input name="input3b" id="input3b" type="text"  placeholder="role" style="margin-bottom: 10;" />
                </br>
                <div class="desktop">
                <p class="gen-black" style="display:inline-block;float:left;margin-left:300;">start date</p>
                <p class="gen-black"style="display:inline-block;margin-bottom:20;"></p>
                ...
                <div id="content3" style="display:none">
                    ...
                    <input name="input4a" id="input4a" type="text" placeholder="company name" />
                <input name="input4b" id="input4b" type="text"  placeholder="role" style="margin-bottom: 10;" />
                </br>
                <div class="desktop">
                <p class="gen-black" style="display:inline-block;float:left;margin-left:300;">start date</p>
                <p class="gen-black"style="display:inline-block;margin-bottom:20;"></p>
                ...
                <div id="content4" style="display:none">
                    ...
                    <input name="input5a" id="input5a" type="text" placeholder="company name" />
                <input name="input5b" id="input5b" type="text"  placeholder="role" style="margin-bottom: 10;" />
                </br>
                <div class="desktop">
                <p class="gen-black" style="display:inline-block;float:left;margin-left:300;">start date</p>
                <p class="gen-black"style="display:inline-block;margin-bottom:20;"></p>
                ...
                <div id="content5" style="display:none">
                    ...
                    <input name="input6a" id="input6a" type="text" placeholder="company name" />
                <input name="input6b" id="input6b" type="text"  placeholder="role" style="margin-bottom: 10;" />
                </br>
                <div class="desktop">
                <p class="gen-black" style="display:inline-block;float:left;margin-left:300;">start date</p>
                <p class="gen-black"style="display:inline-block;margin-bottom:20;"></p>
                ...
                <div id="content6" style="display:none">
                    ...
                    <input name="input7a" id="input7a" type="text" placeholder="company name" />
                <input name="input7b" id="input7b" type="text"  placeholder="role" style="margin-bottom: 10;" />
                </br>
                <div class="desktop">
                <p class="gen-black" style="display:inline-block;float:left;margin-left:300;">start date</p>
                <p class="gen-black"style="display:inline-block;margin-bottom:20;"></p>
                ...
                <div id="content7" style="display:none">
                    ...
                    <input name="input8a" id="input8a" type="text" placeholder="company name" />
                <input name="input8b" id="input8b" type="text"  placeholder="role" style="margin-bottom: 10;" />
                </br>
                <div class="desktop">
                <p class="gen-black" style="display:inline-block;float:left;margin-left:300;">start date</p>
                <p class="gen-black"style="display:inline-block;margin-bottom:20;"></p>
                ...
                <div id="content8" style="display:none">
                    ...
                    <input name="input9a" id="input9a" type="text" placeholder="company name" />
                <input name="input9b" id="input9b" type="text"  placeholder="role" style="margin-bottom: 10;" />
                </br>
                <div class="desktop">
                <p class="gen-black" style="display:inline-block;float:left;margin-left:300;">start date</p>
                <p class="gen-black"style="display:inline-block;margin-bottom:20;"></p>
                ...
                <div id="content9" style="display:none">
                    ...
                    <input name="input10a" id="input10a" type="text" placeholder="company name" />
                <input name="input10b" id="input10b" type="text"  placeholder="role" style="margin-bottom: 10;" />
                </br>
                <div class="desktop">
                <p class="gen-black" style="display:inline-block;float:left;margin-left:300;">start date</p>
                <p class="gen-black"style="display:inline-block;margin-bottom:20;"></p>
                ...
                <div id="content10" style="display:none">
                    ...
                    <input name="input11a" id="input1a" type="text" placeholder="company name" />
                <input name="input11b" id="input11b" type="text"  placeholder="role" style="margin-bottom: 10;" />
                </br>
                <div class="desktop">
                <p class="gen-black" style="display:inline-block;float:left;margin-left:300;">start date</p>
                <p class="gen-black"style="display:inline-block;margin-bottom:20;"></p>
                ...
                <input style="width:45%;display:inline-block;margin-right:0;" name="input11c" id="input11c" type="month" />
                <input style="width:45%;display:inline-block;margin-left:0;" name="input11d" id="input11d" type="month" />
                </br>
                    <button id="remove9" type="button" class="gen" >
                        <p class="gen-black">remove</p>
                    </button>

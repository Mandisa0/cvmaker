...
<body>
    ...
    <center>
        ...
        <form action="../php/skills script.php" method="POST">
            ...
            <div class="container_form">
                ...
                <img src="../icon packs/149086-essential-set/png/network.png" width="250" height="250">
                ...
                <input name="input1" id="input1" type="text" placeholder="skill" required />
                </br>
                <button id="add1" type="button" class="gen">
                    <p class="gen-black">add skill</p>
                </button>
                ...
                <div id="content1" style="display:none">
                    ...
                    <input name="input2" id="input2" type="text" placeholder="skill" />
                    </br>
                ...
                <div id="content2" style="display:none">
                    ...
                    <input name="input3" id="input3" type="text" placeholder="skill" />
                    </br>
                ...
                <div id="content3" style="display:none">
                    ...
                    <input name="input4" id="input4" type="text" placeholder="skill" />
                    </br>
                ...
                <div id="content4" style="display:none">
                    ...
                    <input name="input5" id="input5" type="text" placeholder="skill" />
                    </br>
                ...
                <div id="content5" style="display:none">
                    ...
                    <input name="input6" id="input6" type="text" placeholder="skill" />
                    </br>
                ...
                <div id="content6" style="display:none">
                    ...
                    <input name="input7" id="input7" type="text" placeholder="skill" />
                    </br>
                ...
                <div id="content7" style="display:none">
                    ...
                    <input name="input8" id="input8" type="text" placeholder="skill" />
                    </br>
                ...
                <div id="content8" style="display:none">
                    ...
                    <input name="input9" id="input9" type="text" placeholder="skill" />
                    </br>
                ...
                <div id="content9" style="display:none">
                    ...
                    <input name="input10" id="input10" type="text" placeholder="skill" />
                    </br>
                ...
                <div id="content10" style="display:none">
                    ...
                    <input name="input11" id="input11" type="text" placeholder="skill" />
                    </br>
                    <button id="remove9" type="button" class="gen">
                        <p class="gen-black">remove</p>
                    </button>
